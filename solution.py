...
flags.DEFINE_float("kernel_regularization_factor", 0.0005,
                   "Regularization factor of kernel.")
flags.DEFINE_float("bias_regularization_factor", 0.0005,
                   "Regularization factor of bias.")
flags.DEFINE_float("gamma_regularization_factor", 0.0005,
                   "Regularization factor of gamma.")
flags.DEFINE_float("beta_regularization_factor", 0.0005,
...
flags.DEFINE_float("patch_replacement_probability", 0.8,
                   "Probability of applying patch replacement.")
flags.DEFINE_float("random_erasing_probability", 0.8,
...
flags.DEFINE_bool("use_horizontal_flipping_inside_model", False,
                  "Use horizontal flipping inside model.")
flags.DEFINE_bool("use_horizontal_flipping_in_evaluation", False,
...
def main(_):
    ...
    patch_replacement_probability, random_erasing_probability = FLAGS.patch_replacement_probability, FLAGS.random_erasing_probability
    use_data_augmentation_in_training = FLAGS.use_data_augmentation_in_training
    use_horizontal_flipping_inside_model, use_horizontal_flipping_in_evaluation = FLAGS.use_horizontal_flipping_inside_model, FLAGS.use_horizontal_flipping_in_evaluation
