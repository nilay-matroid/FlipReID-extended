...
"""
    ...
    Base: https://github.com/osmr/imgclsmob/blob/v0.0.540/tensorflow2/tf2cv/models/ibnresnet.py
"""
...
from applications.common import Conv2d, BatchNorm, conv1x1_block, conv3x3_block, IBN, SimpleSequential, is_channels_first
from applications.resnet import ResInitBlock
...
def ibn_conv1x1_block(in_channels,
    ...
    data_format : str, default 'channels_last'
        The ordering of the dimensions in tensors.
    """
    return IBNConvBlock(in_channels=in_channels,
                        out_channels=out_channels,
                        kernel_size=1,
                        strides=strides,
                        padding=0,
    ...
    def __init__(self,
        ...
        for i, channels_per_stage in enumerate(channels):
            ...
            for j, out_channels in enumerate(channels_per_stage):
                ...
                stage.add(
                    IBNResUnit(in_channels=in_channels,
                               out_channels=out_channels,
                               strides=strides,
                               conv1_ibn=conv1_ibn,
                               data_format=data_format,
...
def get_ibnresnet(blocks,
    ...
    if blocks == 50:
        ...
        raise ValueError(
            "Unsupported IBN-ResNet with number of blocks: {}".format(blocks))

    init_block_channels = 64
    channels_per_layers = [256, 512, 1024, 2048]
    channels = [[ci] * li for (ci, li) in zip(channels_per_layers, layers)]

    net = IBNResNet(channels=channels,
