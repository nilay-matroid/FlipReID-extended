...
"""
    ...
    Base: https://github.com/osmr/imgclsmob/blob/v0.0.540/tensorflow2/tf2cv/models/resnet.py
"""

__all__ = [
    'ResNet', 'resnet10', 'resnet12', 'resnet14', 'resnetbc14b', 'resnet16',
    'resnet18_wd4', 'resnet18_wd2', 'resnet18_w3d4', 'resnet18', 'resnet26',
    'resnetbc26b', 'resnet34', 'resnetbc38b', 'resnet50', 'resnet50b',
    'resnet101', 'resnet101b', 'resnet152', 'resnet152b', 'resnet200',
    'resnet200b', 'ResBlock', 'ResBottleneck', 'ResUnit', 'ResInitBlock',
    'get_resnet'
]
...
from applications.common import conv1x1_block, conv3x3_block, conv7x7_block, MaxPool2d, SimpleSequential, is_channels_first
...
def _test():
    ...
    for model in models:
        ...
        batch = 4
        x = tf.random.normal((batch, 3, 224,
