...
"""
    ...
    Base: https://github.com/osmr/imgclsmob/blob/v0.0.540/tensorflow2/tf2cv/models/senet.py
"""
...
from applications.common import conv1x1_block, conv3x3_block, SEBlock, MaxPool2d, SimpleSequential, flatten
...
class SENet(tf.keras.Model):
    ...
    def __init__(self,
        ...
        self.output1.add(nn.Dropout(rate=0.2, name="dropout"))
        self.output1.add(
