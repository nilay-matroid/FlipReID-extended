...
from augmentation.transforms import (RandomErasing,
                                     RandomGrayscalePatchReplacement)
...
class ImageAugmentor(object):
    ...
    def __init__(self,
        ...
        if padding_length > 0 or padding_ratio > 0:
            ...
            transforms.append(
                PadIfNeeded(min_height=min_height,
                            min_width=min_width,
                            border_mode=cv2.BORDER_CONSTANT,
                            value=(123.68, 116.779, 103.939)))
            transforms.append(RandomCrop(height=image_height,
                                         width=image_width))
...
def example():
    ...
    image_augmentor = ImageAugmentor(image_height=image_height,
